-- Supabase Migration: 20260916000000_initial_schema.sql
-- (Exact schema synchronized with backend/src/database/migrations/001_initial_schema.sql)
...
-- 8. PAYMENTS, NOTIFICATIONS, CERTIFICATES & AUDIT
