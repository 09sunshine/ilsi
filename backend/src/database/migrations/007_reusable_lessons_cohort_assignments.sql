-- ============================================================================
-- Migration: 007_reusable_lessons_cohort_assignments.sql
-- Description: Refactor LMS content architecture into Reusable Lessons & Cohort-Lesson Assignments
-- ============================================================================

-- 1. Extend programs table with status if not present
...
-- Drop obsolete UNIQUE(user_id, lesson_id) constraint safely and replace with cohort-aware unique index
...
-- Fallback index when cohort_id is null during transitions
