...
import { demoProgress, modules } from "@/data/demo";
import type { ParticipantProgress, Quiz, QuizAttempt } from "@/lib/domain";
...
export function LearningProvider({ children }: { children: ReactNode }) {
  const [progress, setProgress] = useState<ParticipantProgress>(() => ({
    participantId: demoProgress.participantId,
    lessons: { ...demoProgress.lessons },
    attempts: [...demoProgress.attempts],
  }));
