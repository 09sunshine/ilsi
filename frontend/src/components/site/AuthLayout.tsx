...
import { ArrowUpRight, Check, Lock, Loader2 } from "lucide-react";
  ...
  return (
    <div className="mt-6">
      ...
      <button
        ...
        disabled={loading}
        className="mt-5 flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-neutral-200 bg-white text-sm font-semibold text-neutral-900 transition-colors hover:bg-neutral-50 disabled:opacity-50"
      >
